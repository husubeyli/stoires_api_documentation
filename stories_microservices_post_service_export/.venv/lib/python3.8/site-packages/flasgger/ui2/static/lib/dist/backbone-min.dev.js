...
!function (t, e) {
  ...
  var o = e.Events = {
    ...
    off: function off(t, e, n) {
      ...
      for (o = t ? [t] : i.keys(this._events), h = 0, u = o.length; h < u; h++) {
        if (t = o[h], a = this._events[t]) {
          if (this._events[t] = s = [], e || n) for (l = 0, d = a.length; l < d; l++) {
    ...
    stopListening: function stopListening(t, e, n) {
      ...
      if (!s) return this;
      var r = !e && !n;
      n || "object" != _typeof(e) || (n = this), t && ((s = {})[t._listenId] = t);

      for (var a in s) {
        t = s[a], t.off(e, n, this), (r || i.isEmpty(t._events)) && delete this._listeningTo[a];
      }
  ...
  i.each(l, function (t, e) {
    o[e] = function (e, n, s) {
      ...
      return r[a] = e, s || "object" != _typeof(n) || (s = this), e[t](n, s, this), this;
    };
  ...
  i.extend(d.prototype, o, {
    ...
    set: function set(t, e, n) {
      ...
      if ("object" == _typeof(t) ? (r = t, n = e) : (r = {})[t] = e, n || (n = {}), !this._validate(r, n)) return !1;
      a = n.unset, h = n.silent, o = [], c = this._changing, this._changing = !0, c || (this._previousAttributes = i.clone(this.attributes), this.changed = {}), l = this.attributes, u = this._previousAttributes, this.idAttribute in r && (this.id = r[this.idAttribute]);

      for (s in r) {
        e = r[s], i.isEqual(l[s], e) || o.push(s), i.isEqual(u[s], e) ? delete this.changed[s] : this.changed[s] = e, a ? delete l[s] : l[s] = e;
      }
    ...
    save: function save(t, e, n) {
      ...
      if (null == t || "object" == _typeof(t) ? (s = t, n = e) : (s = {})[t] = e, n = i.extend({
        validate: !0
      }, n), s && !n.wait) {
      ...
      return n.success = function (t) {
        h.attributes = o;
        var e = h.parse(t, n);
        return n.wait && (e = i.extend(s || {}, e)), !(i.isObject(e) && !h.set(e, n)) && (c && c(h, t, n), void h.trigger("sync", h, t, n));
  ...
  i.extend(p.prototype, o, {
    ...
    remove: function remove(t, e) {
      ...
      for (s = 0, r = t.length; s < r; s++) {
        o = t[s] = this.get(t[s]), o && (delete this._byId[o.id], delete this._byId[o.cid], a = this.indexOf(o), this.models.splice(a, 1), this.length--, e.silent || (e.index = a, o.trigger("remove", o, this, e)), this._removeReference(o, e));
      }
    ...
    set: function set(t, e) {
      ...
      for (s = 0, r = t.length; s < r; s++) {
        if (h = t[s] || {}, a = h instanceof d ? o = h : h[f.prototype.idAttribute || "id"], c = this.get(a)) x && (_[c.cid] = !0), w && (h = h === o ? o.attributes : h, e.parse && (h = c.parse(h, e)), c.set(h, e), p && !u && c.hasChanged(v) && (u = !0)), t[s] = c;else if (b) {
      ...
      if (m.length || E && E.length) if (p && (u = !0), this.length += m.length, null != l) for (s = 0, r = m.length; s < r; s++) {
