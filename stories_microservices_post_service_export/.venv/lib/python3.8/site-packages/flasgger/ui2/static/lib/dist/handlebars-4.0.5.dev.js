...
!function (t, e) {
  ...
  return function (t) {
    ...
    function r(t, e) {
      ...
      for (var o = Error.prototype.constructor.call(this, t), c = 0; c < s.length; c++) {
        this[s[c]] = o[s[c]];
      }
    ...
    e["default"] = function (t) {
      t.registerHelper("each", function (t, e) {
        ...
        var s = e.fn,
            ...
            h = void 0,
            l = void 0;
        if (e.data && e.ids && (l = i.appendContextPath(e.data.contextPath, e.ids[0]) + "."), i.isFunction(t) && (t = t.call(this)), e.data && (h = i.createFrame(e.data)), t && "object" == _typeof(t)) if (i.isArray(t)) for (var p = t.length; o < p; o++) {
          o in t && r(o, o, o === t.length - 1);
        } else {
          var u = void 0;

          for (var f in t) {
            t.hasOwnProperty(f) && (void 0 !== u && r(u, o - 1), u = f, o++);
          }
    ...
    e["default"] = function (t) {
      t.registerDecorator("inline", function (t, e, r, i) {
        var a = t;
        return e.partials || (e.partials = {}, a = function a(i, _a) {
          var n = r.partials;
    ...
    function i(t, e) {
      function r(r, s, i) {
        ...
        if (null == a && e.compile && (i.partials[i.name] = e.compile(r, t.compilerOptions, e), a = i.partials[i.name](s, i)), null != a) {
          if (i.indent) {
            for (var n = a.split("\n"), o = 0, c = n.length; o < c && (n[o] || o + 1 !== c); o++) {
              n[o] = i.indent + n[o];
            }
      ...
      if (!t || !t.main) throw new g["default"]("Unknown template object: " + _typeof(t));
      ...
      var i = {
        ...
        programs: [],
        program: function program(t, e, r, s, i) {
    ...
    var r = function () {
      ...
      var e = {
        ...
        performAction: function performAction(t, e, r, s, i, a, n) {
          var o = a.length - 1;
    ...
    s.prototype = new l["default"](), s.prototype.Program = function (t) {
      ...
      var e = t.program || t.inverse,
          ...
          s = r,
          c = r;
      if (r && r.chained) for (s = r.body[0].program; c.chained;) {
    ...
    function c(t, e, r) {
      ...
      for (var s = t ? "@" : "", i = [], a = 0, n = "", o = 0, c = e.length; o < c; o++) {
        var h = e[o].part,
            l = e[o].original !== h;
        if (s += (e[o].separator || "") + h, l || ".." !== h && "." !== h && "this" !== h) i.push(h);else {
    ...
    i.prototype = {
      ...
      compile: function compile(t, e, r, s) {
        ...
        for (o = 0, c = i.length; o < c; o++) {
          a = i[o], this.source.currentLocation = a.loc, n = n || a.loc, this[a.opcode].apply(this, a.args);
        }
        ...
        for (o = 0, c = f.length; o < c; o++) {
          f[o] && (p[o] = f[o], d[o] && (p[o + "_d"] = d[o], p.useDecorators = !0));
        }
      ...
      replaceStack: function replaceStack(t) {
        ...
        if (n instanceof s) r = [n.value], e = ["(", r], a = !0;else {
          i = !0;
      ...
      setupParams: function setupParams(t, e, r) {
        ...
        for (var p = e; p--;) {
          c = this.popStack(), r[p] = c, this.trackIds && (n[p] = this.popStack()), this.stringParams && (a[p] = this.popStack(), i[p] = this.popStack());
        }
      ...
      for (var t = "break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield await null true false".split(" "), e = i.RESERVED_WORDS = {}, r = 0, s = t.length; r < s; r++) {
        e[t[r]] = !0;
      }
