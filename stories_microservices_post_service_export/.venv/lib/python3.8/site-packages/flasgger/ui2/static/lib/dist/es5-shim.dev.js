...
!function (t, e) {
  ...
  var t,
      ...
      m = Math.min,
      D = i.toString,
      x = "function" == typeof Symbol && "symbol" == _typeof(Symbol.toStringTag),
    ...
    try {
      ...
      t = function t(_t2) {
    if (!_t2) return !1;
    if ("function" != typeof _t2 && "object" != _typeof(_t2)) return !1;
    if (x) return E(_t2);
    if (j(_t2)) return !1;
    var e = D.call(_t2);
    return e === M || e === I;
  ...
  e = function e(t) {
    return "object" == _typeof(t) && (x ? F(t) : D.call(t) === N);
  };
  ...
  k = function k(t) {
    return "string" == typeof t || "object" == _typeof(t) && (x ? R(t) : D.call(t) === A);
  };
  ...
  P(u, {
    bind: function bind(e) {
      ...
      for (var n, i = h.call(arguments, 1), u = function u() {
      ...
      }, f = T(0, r.length - i.length), s = [], l = 0; l < f; l++) {
        y.call(s, "$" + l);
      }
  ...
  P(n, {
    forEach: function forEach(e) {
      ...
      for (; ++i < a;) {
        i in o && ("undefined" == typeof r ? e(o[i], i, n) : e.call(r, o[i], i, n));
      }
    }
  }, !nt(n.forEach)), P(n, {
    map: function map(e) {
      ...
      for (var f = 0; f < a; f++) {
        f in i && ("undefined" == typeof n ? u[f] = e(i[f], f, o) : u[f] = e.call(n, i[f], f, o));
      }
    ...
    filter: function filter(e) {
      ...
      for (var f = 0; f < a; f++) {
        f in i && (r = i[f], ("undefined" == typeof n ? e(r, f, o) : e.call(n, r, f, o)) && K(u, r));
      }
  ...
  var ot = !1;
  n.reduce && (ot = "object" == _typeof(n.reduce.call("es5", function (t, e, r, n) {
    return n;
  }))), P(n, {
  ...
  var it = !1;
  n.reduceRight && (it = "object" == _typeof(n.reduceRight.call("es5", function (t, e, r, n) {
    return n;
  }))), P(n, {
  ...
  P(n, {
    indexOf: function indexOf(t) {
      ...
      for (arguments.length > 1 && (n = z.ToInteger(arguments[1])), n = n >= 0 ? n : T(0, r + n); n < r; n++) {
  ...
  P(n, {
    lastIndexOf: function lastIndexOf(t) {
      ...
      for (arguments.length > 1 && (n = m(n, z.ToInteger(arguments[1]))), n = n >= 0 ? n : r - Math.abs(n); n >= 0; n--) {
  ...
  P(n, {
    splice: function splice(t, e) {
      for (var r, n = z.ToObject(this), o = [], i = z.ToUint32(n.length), a = z.ToInteger(t), u = a < 0 ? T(i + a, 0) : m(a, i), s = m(T(z.ToInteger(e), 0), i - u), l = 0; l < s;) {
      ...
      if (p < s) {
        ...
        for (var y = i - s; l < y;) {
          r = f(l + s), c = f(l + p), Y(n, r) ? n[c] = n[r] : delete n[c], l += 1;
        }
      ...
      } else if (p > s) for (l = i - s; l > u;) {
        r = f(l + s - 1), c = f(l + p - 1), Y(n, r) ? n[c] = n[r] : delete n[c], l -= 1;
      }
  ...
  var gt = function gt(t) {
    for (var e = z.ToObject(this), r = z.ToUint32(e.length), n = 0; n < arguments.length;) {
  ...
  var Dt = !Q({
    ...
    for (var t in window) {
      try {
        !jt["$" + t] && Y(window, t) && null !== window[t] && "object" == _typeof(window[t]) && Ot(window[t]);
      } catch (e) {
        return !0;
      }
    }
    ...
    return "[object Arguments]" === B(t);
      ...
      Nt = function Nt(e) {
    return null !== e && "object" == _typeof(e) && "number" == typeof e.length && e.length >= 0 && !_(e) && t(e.callee);
  },
  ...
  P(o, {
    keys: function keys(e) {
      var r = t(e),
          n = kt(e),
          o = null !== e && "object" == _typeof(e),
          i = o && k(e);

      if (!o && !r && !n) throw new TypeError("Object.keys called on a non-object");
      var a = [],
          u = xt && r;
      if (i && St || n) for (var s = 0; s < e.length; ++s) {
        K(a, f(s));
      }
      if (!n) for (var l in e) {
        u && "prototype" === l || !Y(e, l) || K(a, f(l));
      }
  ...
  if (he || ce || !le) {
    ...
    Date = function (t) {
      var e = function e(r, n, o, i, a, u, s) {
        var l,
            c = arguments.length;
      ...
      P(e, {
        now: t.now,
        UTC: t.UTC
      }, !0), e.prototype = t.prototype, P(e.prototype, {
        constructor: e
      }, !0);
  ...
  var de = c.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)),
    ...
    multiply: function multiply(t, e) {
      for (var r = -1, n = e; ++r < ge.size;) {
        n += t * ge.data[r], ge.data[r] = n % ge.base, n = Math.floor(n / ge.base);
      }
    },
    divide: function divide(t) {
      for (var e = ge.size, r = 0; --e >= 0;) {
        r += ge.data[e], ge.data[e] = Math.floor(r / t), r = r % t * ge.base;
      }
    },
  ...
  P(c, {
    ...
    s.split = function (n, o) {
      ...
      }), u.length > 1 && u.index < i.length && y.apply(l, H(u, 1)), s = u[0].length, h = f, l.length >= d)));) {
