...
!function () {
  ...
  !function () {
    ...
    return t = function t() {}, t.extend = function (t) {
      function s() {
      ...
      for (var o in t) {
        n[o] = "function" == typeof t[o] && "function" == typeof r[o] && i.test(t[o]) ? function (t, e) {
          return function () {
            var i = this._super;
            this._super = r[t];
  ...
  var e = function e(t) {
    return !("object" != _typeof(t) || t.nodeType || null !== t && t === t.window) && !(t.constructor && !Object.prototype.hasOwnProperty.call(t.constructor.prototype, "isPrototypeOf"));
  },
      i = function i(t) {
    var s, r, n;
    ...
    for (r = 1; r < arguments.length; r++) {
      ...
      for (n in s) {
        s.hasOwnProperty(n) && (s[n] && e(s[n]) ? (t.hasOwnProperty(n) || (t[n] = {}), i(t[n], s[n])) : t[n] = s[n]);
      }
    }
  ...
  n.prototype = {
    ...
    trigger: function trigger(t) {
      if (this.callbacks && this.callbacks[t] && this.callbacks[t].length) for (var e = 0; e < this.callbacks[t].length; e++) {
        this.callbacks[t][e]();
      }
      return this;
    },
    ...
    getEditorClass: function getEditorClass(t) {
      var e;
    ...
    compileTemplate: function compileTemplate(t, e) {
    ...
    notifyWatchers: function notifyWatchers(t) {
      if (!this.watchlist || !this.watchlist[t]) return this;
    ...
    _getDefinitions: function _getDefinitions(t, e) {
      if (e = e || "#/definitions/", t.definitions) for (var i in t.definitions) {
        t.definitions.hasOwnProperty(i) && (this.refs[e + i] = t.definitions[i], t.definitions[i].definitions && this._getDefinitions(t.definitions[i], e + i + "/definitions/"));
      }
    },
    _getExternalRefs: function _getExternalRefs(t) {
      var e = {},
          i = function i(t) {
        for (var i in t) {
      ...
      t.$ref && "object" != _typeof(t.$ref) && "#" !== t.$ref.substr(0, 1) && !this.refs[t.$ref] && (e[t.$ref] = !0);

      for (var s in t) {
        if (t.hasOwnProperty(s)) if (t[s] && "object" == _typeof(t[s]) && Array.isArray(t[s])) for (var r = 0; r < t[s].length; r++) {
          "object" == _typeof(t[s][r]) && i(this._getExternalRefs(t[s][r]));
        } else t[s] && "object" == _typeof(t[s]) && i(this._getExternalRefs(t[s]));
      }

      return e;
    },
    _loadExternalRefs: function _loadExternalRefs(t, e) {
      var i = this,
        ...
        if (!i.refs[t]) {
          ...
          s.open("GET", t, !0), s.onreadystatechange = function () {
            if (4 == s.readyState) {
              ...
              if (!r || "object" != _typeof(r)) throw "External ref does not contain a valid schema - " + t;
    ...
    expandRefs: function expandRefs(t) {
      for (t = i({}, t); t.$ref;) {
        var e = t.$ref;
    ...
    expandSchema: function expandSchema(t) {
      var e,
          r = this,
          n = i({}, t);

      if ("object" == _typeof(t.type) && (Array.isArray(t.type) ? s(t.type, function (e, i) {
        "object" == _typeof(i) && (t.type[e] = r.expandSchema(i));
      }) : t.type = r.expandSchema(t.type)), "object" == _typeof(t.disallow) && (Array.isArray(t.disallow) ? s(t.disallow, function (e, i) {
        "object" == _typeof(i) && (t.disallow[e] = r.expandSchema(i));
        ...
        "object" != _typeof(i) || Array.isArray(i) || (t.dependencies[e] = r.expandSchema(i));
      ...
      if (t["extends"]) {
        if (Array.isArray(t["extends"])) for (e = 0; e < t["extends"].length; e++) {
    ...
    extendSchemas: function extendSchemas(t, e) {
      t = i({}, t), e = i({}, e);
      var r = this,
          n = {};
      return s(t, function (t, i) {
        "undefined" != typeof e[t] ? "required" === t && "object" == _typeof(i) && Array.isArray(i) ? n.required = i.concat(e[t]).reduce(function (t, e) {
          return t.indexOf(e) < 0 && t.push(e), t;
        }, []) : "type" !== t || "string" != typeof i && !Array.isArray(i) ? "object" == _typeof(i) && Array.isArray(i) ? n[t] = i.filter(function (i) {
          return -1 !== e[t].indexOf(i);
        }) : "object" == _typeof(i) && null !== i ? n[t] = r.extendSchemas(i, e[t]) : n[t] = i : ("string" == typeof i && (i = [i]), "string" == typeof e.type && (e.type = [e.type]), n.type = i.filter(function (t) {
          return -1 !== e.type.indexOf(t);
        }), 1 === n.type.length && "string" == typeof n.type[0] && (n.type = n.type[0])) : n[t] = i;
      }), s(e, function (e, i) {
    ...
    init: function init(t, e) {
      this.jsoneditor = t, this.schema = e || this.jsoneditor.schema, this.options = {}, this.translate = this.jsoneditor.translate || n.defaults.translate;
    },
    validate: function validate(t) {
      return this._validateSchema(this.schema, t);
    },
    _validateSchema: function _validateSchema(t, e, r) {
      var o,
          a,
          h,
          l = this,
      ...
      if (t["extends"]) for (a = 0; a < t["extends"].length; a++) {
        d = d.concat(this._validateSchema(t["extends"][a], e, r));
      }
      if (t.allOf) for (a = 0; a < t.allOf.length; a++) {
      ...
      })), t.type) if (Array.isArray(t.type)) {
      ...
      if (t.disallow) if (Array.isArray(t.disallow)) {
      ...
      if ("number" == typeof e) (t.multipleOf || t.divisibleBy) && (o = e / (t.multipleOf || t.divisibleBy), o !== Math.floor(o) && d.push({
        path: r,
        property: t.multipleOf ? "multipleOf" : "divisibleBy",
        message: this.translate("error_multipleOf", [t.multipleOf || t.divisibleBy])
      })), t.hasOwnProperty("maximum") && (t.exclusiveMaximum && e >= t.maximum ? d.push({
        path: r,
        property: "maximum",
        message: this.translate("error_maximum_excl", [t.maximum])
      }) : !t.exclusiveMaximum && e > t.maximum && d.push({
        path: r,
        property: "maximum",
        message: this.translate("error_maximum_incl", [t.maximum])
      })), t.hasOwnProperty("minimum") && (t.exclusiveMinimum && e <= t.minimum ? d.push({
        path: r,
        property: "minimum",
        message: this.translate("error_minimum_excl", [t.minimum])
      }) : !t.exclusiveMinimum && e < t.minimum && d.push({
        path: r,
        property: "minimum",
      ...
      }));else if ("object" == _typeof(e) && null !== e && Array.isArray(e)) {
        if (t.items) if (Array.isArray(t.items)) for (a = 0; a < e.length; a++) {
          if (t.items[a]) d = d.concat(this._validateSchema(t.items[a], e[a], r + "." + a));else {
      ...
      } else if ("object" == _typeof(e) && null !== e) {
        if (t.maxProperties) {
          o = 0;

          for (a in e) {
            e.hasOwnProperty(a) && o++;
          }
        ...
        if (t.required && Array.isArray(t.required)) for (a = 0; a < t.required.length; a++) {
          "undefined" == typeof e[t.required[a]] && d.push({
            path: r,
            property: "required",
        ...
        var f = {};
        if (t.properties) for (a in t.properties) {
          t.properties.hasOwnProperty(a) && (f[a] = !0, d = d.concat(this._validateSchema(t.properties[a], e[a], r + "." + a)));
        }
        if (t.patternProperties) for (a in t.patternProperties) {
          if (t.patternProperties.hasOwnProperty(a)) {
            var g = new RegExp(a);

            for (h in e) {
              e.hasOwnProperty(h) && g.test(h) && (f[h] = !0, d = d.concat(this._validateSchema(t.patternProperties[a], e[h], r + "." + h)));
            }
          }
        }
        if ("undefined" != typeof t.additionalProperties || !this.jsoneditor.options.no_additional_properties || t.oneOf || t.anyOf || (t.additionalProperties = !1), "undefined" != typeof t.additionalProperties) for (a in e) {
        ...
        if (t.dependencies) for (a in t.dependencies) {
          if (t.dependencies.hasOwnProperty(a) && "undefined" != typeof e[a]) if (Array.isArray(t.dependencies[a])) for (h = 0; h < t.dependencies[a].length; h++) {
            "undefined" == typeof e[t.dependencies[a][h]] && d.push({
              path: r,
    ...
    _checkType: function _checkType(t, e) {
      return "string" == typeof t ? "string" === t ? "string" == typeof e : "number" === t ? "number" == typeof e : "integer" === t ? "number" == typeof e && e === Math.floor(e) : "boolean" === t ? "boolean" == typeof e : "array" === t ? Array.isArray(e) : "object" === t ? null !== e && !Array.isArray(e) && "object" == _typeof(e) : "null" !== t || null === e : !this._validateSchema(t, e).length;
    }
  }), n.AbstractEditor = t.extend({
    onChildEditorChange: function onChildEditorChange(t) {
      this.onChange(!0);
    },
      ...
      if (this.watched = {}, this.schema.vars && (this.schema.watch = this.schema.vars), this.watched_values = {}, this.watch_listener = function () {
        ...
        for (var o in this.schema.watch) {
          if (this.schema.watch.hasOwnProperty(o)) {
            if (e = this.schema.watch[o], Array.isArray(e) ? i = [e[0]].concat(e[1].split(".")) : (i = e.split("."), t.theme.closest(t.container, '[data-schemaid="' + i[0] + '"]') || i.unshift("#")), s = i.shift(), "#" === s && (s = t.jsoneditor.schema.id || "root"), r = t.theme.closest(t.container, '[data-schemaid="' + s + '"]'), !r) throw "Could not find ancestor node with id " + s;
    ...
    addLinks: function addLinks() {
      if (!this.no_link_holder && (this.link_holder = this.theme.getLinksHolder(), this.container.appendChild(this.link_holder), this.schema.links)) for (var t = 0; t < this.schema.links.length; t++) {
        this.addLink(this.getLink(this.schema.links[t]));
      }
    },
    getButton: function getButton(t, e, i) {
    ...
    getLink: function getLink(t) {
      ...
      if ("image" === r) {
        ...
        this.theme.createImageLink(e, i, o), this.link_watchers.push(function (e) {
          var s = n(e);
        ...
        a.setAttribute("controls", "controls"), this.theme.createMediaLink(e, i, a), this.link_watchers.push(function (e) {
          var s = n(e);
          i.setAttribute("href", s), i.textContent = t.rel || s, a.setAttribute("src", s);
        });
      } else e = this.theme.getBlockLink(), e.setAttribute("target", "_blank"), e.textContent = t.rel, this.link_watchers.push(function (i) {
        var s = n(i);
      ...
      if (this.watched_values) {
        ...
        if (this.watched) {
          ...
          for (var n in this.watched) {
            this.watched.hasOwnProperty(n) && (r = i.jsoneditor.getEditor(this.watched[n]), s = r ? r.getValue() : null, i.watched_values[n] !== s && (e = !0), t[n] = s);
          }
        }
    ...
    getHeaderText: function getHeaderText(t) {
    ...
    getDefault: function getDefault() {
      ...
      if (t && Array.isArray(t) && (t = t[0]), t && "object" == _typeof(t) && (t = t.type), t && Array.isArray(t) && (t = t[0]), "string" == typeof t) {
    ...
    showValidationErrors: function showValidationErrors(t) {}
    ...
    setValue: function setValue(t, e, i) {
      if ((!this.template || i) && (null === t || "undefined" == typeof t ? t = "" : "object" == _typeof(t) ? t = JSON.stringify(t) : "string" != typeof t && (t = "" + t), t !== this.serialized)) {
    ...
    build: function build() {
      var t = this;
      if (this.options.compact || (this.header = this.label = this.theme.getFormInputLabel(this.getTitle(), this.isRequired())), this.schema.description && (this.description = this.theme.getFormInputDescription(this.schema.description)), this.format = this.schema.format, !this.format && this.schema.media && this.schema.media.type && (this.format = this.schema.media.type.replace(/(^(application|text)\/(x-)?(script\.)?)|(-source$)/g, "")), !this.format && this.options.default_format && (this.format = this.options.default_format), this.options.format && (this.format = this.options.format), this.format) {
      ...
      "undefined" != typeof this.schema.maxLength && this.input.setAttribute("maxlength", this.schema.maxLength), "undefined" != typeof this.schema.pattern ? this.input.setAttribute("pattern", this.schema.pattern) : "undefined" != typeof this.schema.minLength && this.input.setAttribute("pattern", ".{" + this.schema.minLength + ",}"), this.options.compact ? this.container.className += " compact" : this.options.input_width && (this.input.style.width = this.options.input_width), (this.schema.readOnly || this.schema.readonly || this.schema.template) && (this.always_disabled = !0, this.input.disabled = !0), this.input.addEventListener("change", function (e) {
        ...
        if (t) {
          var e,
              i = t.offsetHeight;
          if (t.offsetHeight < t.scrollHeight) for (e = 0; t.offsetHeight < t.scrollHeight + 3 && !(e > 100);) {
            e++, i++, t.style.height = i + "px";
          } else {
            for (e = 0; t.offsetHeight >= t.scrollHeight + 3 && !(e > 100);) {
              e++, i--, t.style.height = i + "px";
            }
    ...
    afterInputReady: function afterInputReady() {
      var t,
          e = this;
      if (this.source_code) if (this.options.wysiwyg && ["html", "bbcode"].indexOf(this.input_type) >= 0 && window.jQuery && window.jQuery.fn && window.jQuery.fn.sceditor) t = i({}, {
    ...
    register: function register() {
      if (this._super(), this.editors) for (var t in this.editors) {
    ...
    enable: function enable() {
      if (this.editjson_button && (this.editjson_button.disabled = !1), this.addproperty_button && (this.addproperty_button.disabled = !1), this._super(), this.editors) for (var t in this.editors) {
        this.editors.hasOwnProperty(t) && this.editors[t].enable();
      }
    },
    disable: function disable() {
      if (this.editjson_button && (this.editjson_button.disabled = !0), this.addproperty_button && (this.addproperty_button.disabled = !0), this.hideEditJSON(), this._super(), this.editors) for (var t in this.editors) {
        ...
        if ("grid" === this.format) {
          ...
          for (s(this.property_order, function (t, e) {
            ...
            if (!s.property_removed) {
              for (var r = !1, o = s.options.hidden ? 0 : s.options.grid_columns || s.getNumColumns(), a = s.options.hidden ? 0 : s.container.offsetHeight, h = 0; h < n.length; h++) {
                n[h].width + o <= 12 && (!a || .5 * n[h].minh < a && 2 * n[h].maxh > a) && (r = h);
              }
            ...
            if (n[t].width < 12) {
              ...
              for (e = 0; e < n[t].editors.length; e++) {
                o === !1 ? o = e : n[t].editors[e].width > n[t].editors[o].width && (o = e), n[t].editors[e].width *= 12 / n[t].width, n[t].editors[e].width = Math.floor(n[t].editors[e].width), a += n[t].editors[e].width;
              }
          ...
          for (this.layout = JSON.stringify(n), r = document.createElement("div"), t = 0; t < n.length; t++) {
            ...
            for (r.appendChild(h), e = 0; e < n[t].editors.length; e++) {
              var l = n[t].editors[e].key,
                  d = this.editors[l];
              d.options.hidden ? d.container.style.display = "none" : this.theme.setGridColumnSize(d.container, n[t].editors[e].width), h.appendChild(d.container);
            }
          }
    ...
    getPropertySchema: function getPropertySchema(t) {
      var e = this.schema.properties[t] || {};
      e = i({}, e);
      var s = !!this.schema.properties[t];
      if (this.schema.patternProperties) for (var r in this.schema.patternProperties) {
      ...
      return !s && this.schema.additionalProperties && "object" == _typeof(this.schema.additionalProperties) && (e = i({}, this.schema.additionalProperties)), e;
    },
    preBuild: function preBuild() {
      ...
      if (this.format = this.options.layout || this.options.object_layout || this.schema.format || this.jsoneditor.options.object_layout || "normal", this.schema.properties = this.schema.properties || {}, this.minwidth = 0, this.maxwidth = 0, this.options.table_row) s(this.schema.properties, function (e, i) {
        ...
        this.defaultProperties = this.schema.defaultProperties || Object.keys(this.schema.properties), t.maxwidth += 1, s(this.defaultProperties, function (e, i) {
    ...
    build: function build() {
      ...
      if (this.options.table_row) this.editor_holder = this.container, s(this.editors, function (e, i) {
        ...
        if (this.options.table) throw "Not supported yet";
        this.header = document.createElement("span"), this.header.textContent = this.getTitle(), this.title = this.theme.getHeader(this.header), this.container.appendChild(this.title), this.container.style.position = "relative", this.editjson_holder = this.theme.getModal(), this.editjson_textarea = this.theme.getTextareaInput(), this.editjson_textarea.style.height = "170px", this.editjson_textarea.style.width = "300px", this.editjson_textarea.style.display = "block", this.editjson_save = this.getButton("Save", "save", "Save"), this.editjson_save.addEventListener("click", function (e) {
        ...
        e.style.clear = "both", this.addproperty_holder.appendChild(e), this.schema.description && (this.description = this.theme.getDescription(this.schema.description), this.container.appendChild(this.description)), this.error_holder = document.createElement("div"), this.container.appendChild(this.error_holder), this.editor_holder = this.theme.getIndentedPanel(), this.editor_holder.style.paddingBottom = "0", this.container.appendChild(this.editor_holder), this.row_container = this.theme.getGridContainer(), this.editor_holder.appendChild(this.row_container), s(this.editors, function (e, i) {
          ...
          e.preventDefault(), e.stopPropagation(), t.collapsed ? (t.editor_holder.style.display = "", t.collapsed = !1, t.setButtonText(t.toggle_button, "", "collapse", "Collapse")) : (t.editor_holder.style.display = "none", t.collapsed = !0, t.setButtonText(t.toggle_button, "", "expand", "Expand"));
    ...
    insertPropertyControlUsingPropertyOrder: function insertPropertyControlUsingPropertyOrder(t, e, i) {
      var s;
    ...
    addPropertyCheckbox: function addPropertyCheckbox(t) {
      var e,
          i,
          s,
          r,
    ...
    removeObjectProperty: function removeObjectProperty(t) {
      this.editors[t] && (this.editors[t].unregister(), delete this.editors[t], this.refreshValue(), this.layoutEditors());
    },
    addObjectProperty: function addObjectProperty(t, e) {
      var i = this;
    ...
    getValue: function getValue() {
      ...
      if (this.jsoneditor.options.remove_empty_properties || this.options.remove_empty_properties) for (var e in t) {
    ...
    refreshValue: function refreshValue() {
      ...
      for (var t in this.editors) {
        this.editors.hasOwnProperty(t) && (this.value[t] = this.editors[t].getValue());
      }
    ...
    refreshAddProperties: function refreshAddProperties() {
      ...
      for (t in this.editors) {
        this.editors.hasOwnProperty(t) && s++;
      }
    ...
    setValue: function setValue(t, e) {
      var i = this;
      t = t || {}, ("object" != _typeof(t) || Array.isArray(t)) && (t = {}), s(this.cached_editors, function (s, r) {
    ...
    register: function register() {
      if (this._super(), this.rows) for (var t = 0; t < this.rows.length; t++) {
    ...
    enable: function enable() {
      if (this.add_row_button && (this.add_row_button.disabled = !1), this.remove_all_rows_button && (this.remove_all_rows_button.disabled = !1), this.delete_last_row_button && (this.delete_last_row_button.disabled = !1), this.rows) for (var t = 0; t < this.rows.length; t++) {
        this.rows[t].enable(), this.rows[t].moveup_button && (this.rows[t].moveup_button.disabled = !1), this.rows[t].movedown_button && (this.rows[t].movedown_button.disabled = !1), this.rows[t].delete_button && (this.rows[t].delete_button.disabled = !1);
      }

      this._super();
    },
    disable: function disable() {
      if (this.add_row_button && (this.add_row_button.disabled = !0), this.remove_all_rows_button && (this.remove_all_rows_button.disabled = !0), this.delete_last_row_button && (this.delete_last_row_button.disabled = !0), this.rows) for (var t = 0; t < this.rows.length; t++) {
        this.rows[t].disable(), this.rows[t].moveup_button && (this.rows[t].moveup_button.disabled = !0), this.rows[t].movedown_button && (this.rows[t].movedown_button.disabled = !0), this.rows[t].delete_button && (this.rows[t].delete_button.disabled = !0);
      }
    ...
    getItemSchema: function getItemSchema(t) {
    ...
    getItemInfo: function getItemInfo(t) {
    ...
    getElementEditor: function getElementEditor(t) {
    ...
    destroyRow: function destroyRow(t, e) {
      var i = t.container;
    ...
    refreshTabs: function refreshTabs(t) {
      var e = this;
      s(this.rows, function (i, s) {
    ...
    setValue: function setValue(t, e) {
      ...
      if (i !== this.serialized) {
        if (this.schema.minItems) for (; t.length < this.schema.minItems;) {
    ...
    refreshValue: function refreshValue(t) {
      var e = this,
      ...
      if (this.value = [], s(this.rows, function (t, i) {
        ...
        var n = !1;
        this.value.length ? 1 === this.value.length ? (this.remove_all_rows_button.style.display = "none", r || this.hide_delete_buttons ? this.delete_last_row_button.style.display = "none" : (this.delete_last_row_button.style.display = "", n = !0)) : r || this.hide_delete_buttons ? (this.delete_last_row_button.style.display = "none", this.remove_all_rows_button.style.display = "none") : (this.delete_last_row_button.style.display = "", this.remove_all_rows_button.style.display = "", n = !0) : (this.delete_last_row_button.style.display = "none", this.remove_all_rows_button.style.display = "none"), this.getMax() && this.getMax() <= this.rows.length || this.hide_add_button ? this.add_row_button.style.display = "none" : (this.add_row_button.style.display = "", n = !0), !this.collapsed && n ? this.controls.style.display = "inline-block" : this.controls.style.display = "none";
      }
    },
    addRow: function addRow(t, e) {
      var i = this,
          r = this.rows.length;
      ...
      i.hide_delete_buttons || (i.rows[r].delete_button = this.getButton(i.getItemTitle(), "delete", "Delete " + i.getItemTitle()), i.rows[r].delete_button.className += " delete", i.rows[r].delete_button.setAttribute("data-i", r), i.rows[r].delete_button.addEventListener("click", function (t) {
      ...
      }), n && n.appendChild(i.rows[r].delete_button)), r && !i.hide_move_buttons && (i.rows[r].moveup_button = this.getButton("", "moveup", "Move up"), i.rows[r].moveup_button.className += " moveup", i.rows[r].moveup_button.setAttribute("data-i", r), i.rows[r].moveup_button.addEventListener("click", function (t) {
        t.preventDefault(), t.stopPropagation();
        var e = 1 * this.getAttribute("data-i");
      ...
      }), n && n.appendChild(i.rows[r].moveup_button)), i.hide_move_buttons || (i.rows[r].movedown_button = this.getButton("", "movedown", "Move down"), i.rows[r].movedown_button.className += " movedown", i.rows[r].movedown_button.setAttribute("data-i", r), i.rows[r].movedown_button.addEventListener("click", function (t) {
        t.preventDefault(), t.stopPropagation();
        var e = 1 * this.getAttribute("data-i"),
            s = i.getValue();
    ...
    addControls: function addControls() {
      ...
      }), this.options.collapsed && r(this.toggle_button, "click"), this.schema.options && "undefined" != typeof this.schema.options.disable_collapse ? this.schema.options.disable_collapse && (this.toggle_button.style.display = "none") : this.jsoneditor.options.disable_collapse && (this.toggle_button.style.display = "none"), this.add_row_button = this.getButton(this.getItemTitle(), "add", "Add " + this.getItemTitle()), this.add_row_button.addEventListener("click", function (e) {
        e.preventDefault(), e.stopPropagation();
        var i = t.rows.length;
        t.row_cache[i] ? (t.rows[i] = t.row_cache[i], t.rows[i].setValue(t.rows[i].getDefault()), t.rows[i].container.style.display = "", t.rows[i].tab && (t.rows[i].tab.style.display = ""), t.rows[i].register()) : t.addRow(), t.active_tab = t.rows[i].tab, t.refreshTabs(), t.refreshValue(), t.onChange(!0);
      }), t.controls.appendChild(this.add_row_button), this.delete_last_row_button = this.getButton("Last " + this.getItemTitle(), "delete", "Delete Last " + this.getItemTitle()), this.delete_last_row_button.addEventListener("click", function (e) {
        e.preventDefault(), e.stopPropagation();
        var i = t.getValue(),
            s = null;
      ...
      }), t.controls.appendChild(this.delete_last_row_button), this.remove_all_rows_button = this.getButton("All", "delete", "Delete All"), this.remove_all_rows_button.addEventListener("click", function (e) {
    ...
    build: function build() {
      ...
      if (this.item_default = e.getDefault(), this.width = e.getNumColumns() + 2, this.options.compact ? (this.panel = document.createElement("div"), this.container.appendChild(this.panel)) : (this.title = this.theme.getHeader(this.getTitle(), this.isRequired()), this.container.appendChild(this.title), this.title_controls = this.theme.getHeaderButtonHolder(), this.title.appendChild(this.title_controls), this.schema.description && (this.description = this.theme.getDescription(this.schema.description), this.container.appendChild(this.description)), this.panel = this.theme.getIndentedPanel(), this.container.appendChild(this.panel), this.error_holder = document.createElement("div"), this.panel.appendChild(this.error_holder)), this.panel.appendChild(this.table), this.controls = this.theme.getButtonHolder(), this.panel.appendChild(this.controls), this.item_has_child_editors) for (var i = e.getChildEditors(), s = e.property_order || Object.keys(i), r = 0; r < s.length; r++) {
    ...
    getElementEditor: function getElementEditor(t, e) {
    ...
    setValue: function setValue(t, e) {
      if (t = t || [], this.schema.minItems) for (; t.length < this.schema.minItems;) {
    ...
    refreshRowButtons: function refreshRowButtons() {
      ...
      var r = !1;
      this.value.length ? 1 === this.value.length || this.hide_delete_buttons ? (this.table.style.display = "", this.remove_all_rows_button.style.display = "none", e || this.hide_delete_buttons ? this.delete_last_row_button.style.display = "none" : (this.delete_last_row_button.style.display = "", r = !0)) : (this.table.style.display = "", e || this.hide_delete_buttons ? (this.delete_last_row_button.style.display = "none", this.remove_all_rows_button.style.display = "none") : (this.delete_last_row_button.style.display = "", this.remove_all_rows_button.style.display = "", r = !0)) : (this.delete_last_row_button.style.display = "none", this.remove_all_rows_button.style.display = "none", this.table.style.display = "none"), this.schema.maxItems && this.schema.maxItems <= this.rows.length || this.hide_add_button ? this.add_row_button.style.display = "none" : (this.add_row_button.style.display = "", r = !0), r ? this.controls.style.display = "" : this.controls.style.display = "none";
    },
    refreshValue: function refreshValue() {
      var t = this;
    ...
    addRow: function addRow(t) {
      ...
      this.hide_delete_buttons || (e.rows[i].delete_button = this.getButton("", "delete", "Delete"), e.rows[i].delete_button.className += " delete", e.rows[i].delete_button.setAttribute("data-i", i), e.rows[i].delete_button.addEventListener("click", function (t) {
        t.preventDefault(), t.stopPropagation();
      ...
      }), r.appendChild(e.rows[i].delete_button)), i && !this.hide_move_buttons && (e.rows[i].moveup_button = this.getButton("", "moveup", "Move up"), e.rows[i].moveup_button.className += " moveup", e.rows[i].moveup_button.setAttribute("data-i", i), e.rows[i].moveup_button.addEventListener("click", function (t) {
        t.preventDefault(), t.stopPropagation();
        var i = 1 * this.getAttribute("data-i");
      ...
      }), r.appendChild(e.rows[i].moveup_button)), this.hide_move_buttons || (e.rows[i].movedown_button = this.getButton("", "movedown", "Move down"), e.rows[i].movedown_button.className += " movedown", e.rows[i].movedown_button.setAttribute("data-i", i), e.rows[i].movedown_button.addEventListener("click", function (t) {
        t.preventDefault(), t.stopPropagation();
        var i = 1 * this.getAttribute("data-i"),
            s = e.getValue();
    ...
    addControls: function addControls() {
      var t = this;
      this.collapsed = !1, this.toggle_button = this.getButton("", "collapse", "Collapse"), this.title_controls && (this.title_controls.appendChild(this.toggle_button), this.toggle_button.addEventListener("click", function (e) {
        e.preventDefault(), e.stopPropagation(), t.collapsed ? (t.collapsed = !1, t.panel.style.display = "", t.setButtonText(this, "", "collapse", "Collapse")) : (t.collapsed = !0, t.panel.style.display = "none", t.setButtonText(this, "", "expand", "Expand"));
      }), this.options.collapsed && r(this.toggle_button, "click"), this.schema.options && "undefined" != typeof this.schema.options.disable_collapse ? this.schema.options.disable_collapse && (this.toggle_button.style.display = "none") : this.jsoneditor.options.disable_collapse && (this.toggle_button.style.display = "none")), this.add_row_button = this.getButton(this.getItemTitle(), "add", "Add " + this.getItemTitle()), this.add_row_button.addEventListener("click", function (e) {
    ...
    unregister: function unregister() {
      if (this._super(), this.editors) for (var t = 0; t < this.editors.length; t++) {
        this.editors[t] && this.editors[t].unregister();
      }
    },
    getNumColumns: function getNumColumns() {
    ...
    enable: function enable() {
      if (this.editors) for (var t = 0; t < this.editors.length; t++) {
    ...
    switchEditor: function switchEditor(t) {
      var e = this;
    ...
    buildChildEditor: function buildChildEditor(t) {
      var e = this,
          s = this.types[t],
    ...
    preBuild: function preBuild() {
      if (this.types = [], this.type = 0, this.editors = [], this.validators = [], this.keep_values = !0, "undefined" != typeof this.jsoneditor.options.keep_oneof_values && (this.keep_values = this.jsoneditor.options.keep_oneof_values), "undefined" != typeof this.options.keep_oneof_values && (this.keep_values = this.options.keep_oneof_values), this.schema.oneOf) this.oneOf = !0, this.types = this.schema.oneOf, s(this.types, function (t, e) {}), delete this.schema.oneOf;else {
        if (this.schema.type && "any" !== this.schema.type) Array.isArray(this.schema.type) ? this.types = this.schema.type : this.types = [this.schema.type];else if (this.types = ["string", "number", "integer", "boolean", "object", "array", "null"], this.schema.disallow) {
          ...
          "object" == _typeof(t) && Array.isArray(t) || (t = [t]);
          var e = [];
    ...
    build: function build() {
      ...
      }), this.editor_holder = document.createElement("div"), e.appendChild(this.editor_holder), this.switcher_options = this.theme.getSwitcherOptions(this.switcher), s(this.types, function (e, s) {
        t.editors[e] = !1;
        var r;
        "string" == typeof s ? (r = i({}, t.schema), r.type = s) : (r = i({}, t.schema, s), s.required && Array.isArray(s.required) && t.schema.required && Array.isArray(t.schema.required) && (r.required = t.schema.required.concat(s.required))), t.validators[e] = new n.Validator(t.jsoneditor, r);
      }), this.switchEditor(0);
    },
    onChildEditorChange: function onChildEditorChange(t) {
    ...
    showValidationErrors: function showValidationErrors(t) {
      var e = this;
      this.oneOf ? s(this.editors, function (r, n) {
        if (n) {
    ...
    build: function build() {
      this.container, this.title = this.header = this.label = this.theme.getFormInputLabel(this.getTitle(), this.isRequired()), this.container.appendChild(this.title), this.options.enum_titles = this.options.enum_titles || [], this["enum"] = this.schema["enum"], this.selected = 0, this.select_options = [], this.html_values = [];

      for (var t = this, e = 0; e < this["enum"].length; e++) {
        this.select_options[e] = this.options.enum_titles[e] || "Value " + (e + 1), this.html_values[e] = this.getHTML(this["enum"][e]);
      }
    ...
    preBuild: function preBuild() {
      ...
      } else if ("boolean" === this.schema.type) t.enum_display = this.schema.options && this.schema.options.enum_titles || ["true", "false"], t.enum_options = ["1", ""], t.enum_values = [!0, !1], this.isRequired() || (t.enum_display.unshift(" "), t.enum_options.unshift("undefined"), t.enum_values.unshift(void 0));else {
        if (!this.schema.enumSource) throw "'select' editor requires the enum property to be set.";
        if (this.enumSource = [], this.enum_display = [], this.enum_options = [], this.enum_values = [], Array.isArray(this.schema.enumSource)) for (a = 0; a < this.schema.enumSource.length; a++) {
          "string" == typeof this.schema.enumSource[a] ? this.enumSource[a] = {
            source: this.schema.enumSource[a]
          } : Array.isArray(this.schema.enumSource[a]) ? this.enumSource[a] = this.schema.enumSource[a] : this.enumSource[a] = i({}, this.schema.enumSource[a]);
    ...
    onInputChange: function onInputChange() {
      var t = this.input.value,
          e = t;
      -1 === this.enum_options.indexOf(t) && (e = this.enum_options[0]), this.value = this.enum_values[this.enum_options.indexOf(t)], this.onChange(!0);
    },
    ...
    onWatchedFieldChange: function onWatchedFieldChange() {
      ...
      if (this.enumSource) {
        ...
        for (var i = [], s = [], r = 0; r < this.enumSource.length; r++) {
          if (Array.isArray(this.enumSource[r])) i = i.concat(this.enumSource[r]), s = s.concat(this.enumSource[r]);else {
            var n = [];
            ...
            if (n = Array.isArray(this.enumSource[r].source) ? this.enumSource[r].source : t[this.enumSource[r].source]) {
              ...
              for (e = 0; e < n.length; e++) {
                var l = n[e];
                this.enumSource[r].value ? h[e] = this.enumSource[r].value({
                  i: e,
                  item: l
                }) : h[e] = n[e], this.enumSource[r].title ? a[e] = this.enumSource[r].title({
                  i: e,
                  item: l
                }) : a[e] = h[e];
              }
    ...
    build: function build() {
      ...
      if (this.options.compact || (this.header = this.label = this.theme.getFormInputLabel(this.getTitle(), this.isRequired())), this.schema.description && (this.description = this.theme.getFormInputDescription(this.schema.description)), !this.schema.format && this.option_keys.length < 8 || "checkbox" === this.schema.format) {
        ...
        for (this.input_type = "select", this.input = this.theme.getSelectInput(this.option_keys), this.input.multiple = !0, this.input.size = Math.min(10, this.option_keys.length), t = 0; t < this.option_keys.length; t++) {
      ...
      this.container.appendChild(this.control), this.control.addEventListener("change", function (i) {
        ...
        for (t = 0; t < e.option_keys.length; t++) {
          (e.select_options[e.option_keys[t]].selected || e.select_options[e.option_keys[t]].checked) && s.push(e.select_values[e.option_keys[t]]);
        }
    ...
    setValue: function setValue(t, e) {
      ...
      for (t = t || [], "object" != _typeof(t) ? t = [t] : Array.isArray(t) || (t = []), i = 0; i < t.length; i++) {
        "string" != typeof t[i] && (t[i] += "");
      }

      for (i in this.select_options) {
        this.select_options.hasOwnProperty(i) && (this.select_options[i]["select" === this.input_type ? "selected" : "checked"] = -1 !== t.indexOf(i));
      }
    ...
    enable: function enable() {
      if (!this.always_disabled) {
        if (this.input) this.input.disabled = !1;else if (this.inputs) for (var t in this.inputs) {
    ...
    disable: function disable() {
      if (this.input) this.input.disabled = !0;else if (this.inputs) for (var t in this.inputs) {
  ...
  n.AbstractTheme = t.extend({
    ...
    setGridColumnSize: function setGridColumnSize(t, e) {},
    getLink: function getLink(t) {
      var e = document.createElement("a");
      return e.setAttribute("href", "#"), e.appendChild(document.createTextNode(t)), e;
    },
    disableHeader: function disableHeader(t) {
      t.style.color = "#ccc";
    },
    disableLabel: function disableLabel(t) {
      t.style.color = "#ccc";
    },
    enableHeader: function enableHeader(t) {
      t.style.color = "";
    },
    enableLabel: function enableLabel(t) {
      t.style.color = "";
    },
    getFormInputLabel: function getFormInputLabel(t) {
      var e = document.createElement("label");
      return e.appendChild(document.createTextNode(t)), e;
    },
    getCheckboxLabel: function getCheckboxLabel(t) {
    ...
    getMultiCheckboxHolder: function getMultiCheckboxHolder(t, e, i) {
    ...
    getSelectInput: function getSelectInput(t) {
      var e = document.createElement("select");
      return t && this.setSelectOptions(e, t), e;
    },
    getSwitcher: function getSwitcher(t) {
    ...
    getSwitcherOptions: function getSwitcherOptions(t) {
      return t.getElementsByTagName("option");
    },
    setSwitcherOptions: function setSwitcherOptions(t, e, i) {
      this.setSelectOptions(t, e, i);
    },
    setSelectOptions: function setSelectOptions(t, e, i) {
      i = i || [], t.innerHTML = "";
    ...
    getRangeInput: function getRangeInput(t, e, i) {
      var s = this.getFormInputField("range");
      return s.setAttribute("min", t), s.setAttribute("max", e), s.setAttribute("step", i), s;
    },
    getFormInputField: function getFormInputField(t) {
      var e = document.createElement("input");
      return e.setAttribute("type", t), e;
    },
    afterInputReady: function afterInputReady(t) {},
    getFormControl: function getFormControl(t, e, i) {
      var s = document.createElement("div");
    ...
    getDescription: function getDescription(t) {
      var e = document.createElement("p");
      return e.innerHTML = t, e;
    },
    getCheckboxDescription: function getCheckboxDescription(t) {
      return this.getDescription(t);
    },
    getFormInputDescription: function getFormInputDescription(t) {
      return this.getDescription(t);
    },
    ...
    getTableHeaderCell: function getTableHeaderCell(t) {
    ...
    addInputError: function addInputError(t, e) {},
    removeInputError: function removeInputError(t) {},
    addTableRowError: function addTableRowError(t) {},
    removeTableRowError: function removeTableRowError(t) {},
    ...
    applyStyles: function applyStyles(t, e) {
      t.style = t.style || {};
    ...
    getTabContentHolder: function getTabContentHolder(t) {
      return t.children[1];
    },
    getTabContent: function getTabContent() {
      return this.getIndentedPanel();
    },
    markTabActive: function markTabActive(t) {
      this.applyStyles(t, {
        opacity: 1,
        background: "white"
      });
    },
    markTabInactive: function markTabInactive(t) {
      this.applyStyles(t, {
        opacity: .5,
        background: ""
      });
    },
    addTab: function addTab(t, e) {
    ...
    createMediaLink: function createMediaLink(t, e, i) {
      t.appendChild(e), i.style.width = "100%", t.appendChild(i);
    },
    createImageLink: function createImageLink(t, e, i) {
    ...
    getFormInputLabel: function getFormInputLabel(t, e) {
      var i = this._super(t);
    ...
    afterInputReady: function afterInputReady(t) {
      t.controlgroup || (t.controlgroup = this.closest(t, ".control-group"), t.controls = this.closest(t, ".controls"), this.closest(t, ".compact") && (t.controlgroup.className = t.controlgroup.className.replace(/control-group/g, "").replace(/[ ]{2,}/g, " "), t.controls.className = t.controlgroup.className.replace(/controls/g, "").replace(/[ ]{2,}/g, " "), t.style.marginBottom = 0));
    },
    getIndentedPanel: function getIndentedPanel() {
      var t = document.createElement("div");
    ...
    getFormControl: function getFormControl(t, e, i) {
      ...
      return r.className = "controls", t && "checkbox" === e.getAttribute("type") ? (s.appendChild(r), t.className += " checkbox", t.appendChild(e), r.appendChild(t), r.style.height = "30px") : (t && (t.className += " control-label", s.appendChild(t)), r.appendChild(e), s.appendChild(r)), i && r.appendChild(i), s;
    },
    getHeaderButtonHolder: function getHeaderButtonHolder() {
    ...
    addInputError: function addInputError(t, e) {
      t.controlgroup && t.controls && (t.controlgroup.className += " error", t.errmsg ? t.errmsg.style.display = "" : (t.errmsg = document.createElement("p"), t.errmsg.className = "help-block errormsg", t.controls.appendChild(t.errmsg)), t.errmsg.textContent = e);
    },
    removeInputError: function removeInputError(t) {
      t.errmsg && (t.errmsg.style.display = "none", t.controlgroup.className = t.controlgroup.className.replace(/\s?error/g, ""));
    },
    getTabHolder: function getTabHolder() {
      var t = document.createElement("div");
      return t.className = "tabbable tabs-left", t.innerHTML = "<ul class='nav nav-tabs span2' style='margin-right: 0;'></ul><div class='tab-content span10' style='overflow:visible;'></div>", t;
    },
    getTab: function getTab(t) {
    ...
    updateProgressBar: function updateProgressBar(t, e) {
      t && (t.firstChild.style.width = e + "%");
    },
    updateProgressBarUnknown: function updateProgressBarUnknown(t) {
    ...
    updateProgressBarUnknown: function updateProgressBarUnknown(t) {
      if (t) {
        var e = t.firstChild;
        t.className = "progress progress-striped active", e.removeAttribute("aria-valuenow"), e.style.width = "100%", e.innerHTML = "";
      }
    }
    ...
    addInputError: function addInputError(t, e) {
      t.group && (t.group.className += " error", t.errmsg ? t.errmsg.style.display = "" : (t.insertAdjacentHTML("afterend", '<small class="error"></small>'), t.errmsg = t.parentNode.getElementsByClassName("error")[0]), t.errmsg.textContent = e);
    },
    removeInputError: function removeInputError(t) {
    ...
    getTabHolder: function getTabHolder() {
      var t = document.createElement("div");
      return t.className = "row", t.innerHTML = "<dl class='tabs vertical two columns'></dl><div class='tabs-content ten columns'></div>", t;
    },
    setGridColumnSize: function setGridColumnSize(t, e) {
    ...
    getFormInputLabel: function getFormInputLabel(t, e) {
      ...
      return i.style.display = "block", i.style.marginBottom = "3px", i.style.fontWeight = "bold", e && (i.className += " required"), i;
    },
    getFormInputDescription: function getFormInputDescription(t) {
      var e = this._super(t);

      return e.style.fontSize = ".8em", e.style.margin = 0, e.style.display = "inline-block", e.style.fontStyle = "italic", e;
    },
    getIndentedPanel: function getIndentedPanel() {
      var t = this._super();

      return t.style.border = "1px solid #ddd", t.style.padding = "5px", t.style.margin = "5px", t.style.borderRadius = "3px", t;
    },
    getChildEditorHolder: function getChildEditorHolder() {
      var t = this._super();
    ...
    getHeaderButtonHolder: function getHeaderButtonHolder() {
      var t = this.getButtonHolder();
      return t.style.display = "inline-block", t.style.marginLeft = "10px", t.style.fontSize = ".8em", t.style.verticalAlign = "middle", t;
    },
    getTable: function getTable() {
      var t = this._super();
    ...
    getFormControl: function getFormControl(t, e, i) {
      ...
      return "checkbox" === e.type ? (s.style.lineHeight = "25px", s.style.padding = "3px 0") : s.style.padding = "4px 0 8px 0", s;
    },
    getDescription: function getDescription(t) {
      var e = document.createElement("span");
    ...
    getFormInputLabel: function getFormInputLabel(t, e) {
      ...
      return i.style.fontWeight = "bold", i.style.display = "block", e && (i.className += " required"), i.textContent = t, i;
    },
    getButton: function getButton(t, e, i) {
      var s = document.createElement("button");
      s.className = "ui-button ui-widget ui-state-default ui-corner-all", e && !t ? (s.className += " ui-button-icon-only", e.className += " ui-button-icon-primary ui-icon-primary", s.appendChild(e)) : e ? (s.className += " ui-button-text-icon-primary", e.className += " ui-button-icon-primary ui-icon-primary", s.appendChild(e)) : s.className += " ui-button-text-only";
    ...
    getIndentedPanel: function getIndentedPanel() {
      var t = document.createElement("div");
      return t.className = "ui-widget-content ui-corner-all", t.style.padding = "1em 1.4em", t.style.marginBottom = "20px", t;
    },
    afterInputReady: function afterInputReady(t) {
      t.controls || (t.controls = this.closest(t, ".form-control"));
    },
    addInputError: function addInputError(t, e) {
      t.controls && (t.errmsg ? t.errmsg.style.display = "" : (t.errmsg = document.createElement("div"), t.errmsg.className = "ui-state-error", t.controls.appendChild(t.errmsg)), t.errmsg.textContent = e);
    },
    removeInputError: function removeInputError(t) {
  ...
  }, n.defaults.theme = "html", n.defaults.template = "default", n.defaults.options = {}, n.defaults.translate = function (t, e) {
  ...
  n.defaults.resolvers.unshift(function (t) {
    ...
    return "array" === t.type && t.items && !Array.isArray(t.items) && t.uniqueItems && t.items["enum"] && ["string", "number", "integer"].indexOf(t.items.type) >= 0 ? "multiselect" : void 0;
  }), n.defaults.resolvers.unshift(function (t) {
    return t.oneOf ? "multiple" : void 0;
  }), function () {
    if (window.jQuery || window.Zepto) {
      var t = window.jQuery || window.Zepto;
      t.jsoneditor = n.defaults, t.fn.jsoneditor = function (t) {
        var e = this,
        ...
        if ("value" === t) {
          ...
          "destroy" === t ? i && (i.destroy(), this.data("jsoneditor", null)) : (i && i.destroy(), i = new n(this.get(0), t), this.data("jsoneditor", i), i.on("change", function () {
            e.trigger("change");
          }), i.on("ready", function () {
            e.trigger("ready");
          }));
