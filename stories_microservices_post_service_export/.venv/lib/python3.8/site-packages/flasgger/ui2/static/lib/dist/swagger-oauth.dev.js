  ...
  if (o) {
    ...
    for (i in n) {
      ...
      if ("oauth2" === a.type && a.scopes) {
        ...
        } else for (t in a.scopes) {
          e.push({
            scope: t,
            description: a.scopes[t],
            OAuthSchemeKey: i
          });
        }
      }
...
function clientCredentialsFlow(e, o, i) {
  ...
  $.ajax({
    ...
    type: "POST",
    data: n,
    success: function success(e, o, n) {
      onOAuthComplete(e, i);
    },
    error: function error(e, o, i) {
      onOAuthComplete("");
    }
  });
}
...
window.processOAuthCode = function (e) {
  ...
  clientSecret && (p.client_secret = clientSecret), $.ajax({
    ...
    type: "POST",
    data: p,
    success: function success(e, i, n) {
      onOAuthComplete(e, o);
    },
    error: function error(e, o, i) {
      onOAuthComplete("");
