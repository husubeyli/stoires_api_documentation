  ...
  !function () {
    ...
    t.apikey_auth = e({
      ...
      main: function main(e, t, n, r, i) {
        ...
        return '<label data-sw-translate for="' + c((o = null != (o = n.responseContentTypeId || (null != t ? t.responseContentTypeId : t)) ? o : l, _typeof(o) === u ? o.call(s, {
          name: "responseContentTypeId",
          hash: {},
          data: i
        }) : o)) + '">Response Content Type</label>\n<select name="responseContentType" id="' + c((o = null != (o = n.responseContentTypeId || (null != t ? t.responseContentTypeId : t)) ? o : l, _typeof(o) === u ? o.call(s, {
          name: "responseContentTypeId",
          hash: {},
          data: i
    ...
    toggleEndpointListForResource: function toggleEndpointListForResource(e) {
    ...
    expandEndpointListForResource: function expandEndpointListForResource(e) {
    ...
    collapseEndpointListForResource: function collapseEndpointListForResource(e) {
      var e = Docs.escapeResourceName(e);
    ...
    expandOperationsForResource: function expandOperationsForResource(e) {
    ...
    collapseOperationsForResource: function collapseOperationsForResource(e) {
    ...
    escapeResourceName: function escapeResourceName(e) {
      return e.replace(/[!"#$%&'()*+,.\/:;<=>?@\[\\\]\^`{|}~]/g, "\\$&");
    },
    expandOperation: function expandOperation(e) {
      e.slideDown();
    },
    collapseOperation: function collapseOperation(e) {
      e.slideUp();
    }
  }, function (e, t) {
    "use strict";

    "function" == typeof define && define.amd ? define(t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = t() : e.returnExports = t();
  }(this, function () {
    var e,
        t,
        n = Array,
        ...
        _ = Math.min,
        x = a.toString,
        A = "function" == typeof Symbol && "symbol" == _typeof(Symbol.toStringTag),
      ...
      try {
        ...
        e = function e(_e2) {
      if (!_e2) return !1;
      if ("function" != typeof _e2 && "object" != _typeof(_e2)) return !1;
      if (A) return O(_e2);
      if (E(_e2)) return !1;
      var t = x.call(_e2);
      return t === k || t === T;
    ...
    t = function t(e) {
      return "object" == _typeof(e) && (A ? I(e) : x.call(e) === D);
    };
    ...
    L = function L(e) {
      return "string" == typeof e || "object" == _typeof(e) && (A ? R(e) : x.call(e) === U);
    };
    ...
    q(s, {
      bind: function bind(t) {
        ...
        for (var r, a = h.call(arguments, 1), s = function s() {
    ...
    var ie = !1;
    r.reduce && (ie = "object" == _typeof(r.reduce.call("es5", function (e, t, n, r) {
      return r;
    }))), q(r, {
    ...
    var ae = !1;
    r.reduceRight && (ae = "object" == _typeof(r.reduceRight.call("es5", function (e, t, n, r) {
      return r;
    }))), q(r, {
    ...
    q(r, {
      splice: function splice(e, t) {
        ...
        if (f < u) {
          ...
          for (var d = a - u; c < d;) {
            n = l(c + u), p = l(c + f), F(r, n) ? r[p] = r[n] : delete r[p], c += 1;
          }
    ...
    var xe = !K({
      ...
      for (var e in window) {
        try {
          !Ee["$" + e] && F(window, e) && null !== window[e] && "object" == _typeof(window[e]) && je(window[e]);
        } catch (t) {
          return !0;
        }
      }
      ...
      return "[object Arguments]" === V(e);
        ...
        De = function De(t) {
      return null !== t && "object" == _typeof(t) && "number" == typeof t.length && t.length >= 0 && !Z(t) && e(t.callee);
    },
    ...
    q(i, {
      keys: function keys(t) {
        ...
        var o = [],
            s = Ae && n;
        if (a && Se || r) for (var u = 0; u < t.length; ++u) {
          G(o, l(u));
        }
        if (!r) for (var c in t) {
    ...
    if (ht || pt || !ct) {
      ...
      Date = function (e) {
        var t = function t(n, r, i, a, o, s, u) {
          var c,
              p = arguments.length;
    ...
    var mt = p.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)),
      ...
      if (r = "", n < 0 && (r = "-", n = -n), i = "0", n > 1e-21) if (a = gt.log(n * gt.pow(2, 69, 1)) - 69, o = a < 0 ? n * gt.pow(2, -a, 1) : n / gt.pow(2, a, 1), o *= 4503599627370496, a = 52 - a, a > 0) {
        for (gt.multiply(0, o), s = t; s >= 7;) {
          gt.multiply(1e7, 0), s -= 7;
        }

        for (gt.multiply(gt.pow(10, s, 1), 0), s = a - 1; s >= 23;) {
          gt.divide(1 << 23), s -= 23;
        }
    ...
    q(p, {
      ...
      u.split = function (r, i) {
        ...
        }), s.length > 1 && s.index < a.length && d.apply(c, H(s, 1)), u = s[0].length, h = l, c.length >= m)));) {
    ...
    return function e(t, n, r) {
      ...
      1: [function (e, t, n) {
        ...
        function a(e, t, n) {
          ...
          var _ = 0,
              ...
              E = 0,
              O = new o.Parser({
            onopentag: function onopentag(e, n) {
              if (j) return void E++;
              var a = new c(e, n);
              x.push(a);
              var o,
      ...
      2: [function (e, t, n) {
        ...
        function i(e) {
          ...
          for (t = 0, n = 0; t < r; t += 4, n += 3) {
            i = u[e.charCodeAt(t)] << 18 | u[e.charCodeAt(t + 1)] << 12 | u[e.charCodeAt(t + 2)] << 6 | u[e.charCodeAt(t + 3)], o[l++] = i >> 16 & 255, o[l++] = i >> 8 & 255, o[l++] = 255 & i;
          }
      ...
      4: [function (e, t, n) {
        (function (t) {
          ...
          n.alloc = function (e, t, n) {
            ...
            var s = new i(e);
            if ("string" == typeof a) for (var l = new i(a, r), u = l.length, c = -1; ++c < e;) {
              s[c] = l[c % u];
            } else s.fill(a);
            return s;
      ...
      5: [function (e, t, n) {
        (function (t) {
          ...
          function c(e, t) {
            if (l(t), e = a(e, t < 0 ? 0 : 0 | m(t)), !o.TYPED_ARRAY_SUPPORT) for (var n = 0; n < t; ++n) {
              e[n] = 0;
            }
            return e;
          }
          ...
          o.prototype.slice = function (e, t) {
            ...
            var i,
                a = r - n;
            if (this === e && n < t && t < r) for (i = a - 1; i >= 0; --i) {
              e[i + t] = this[i + n];
      ...
      7: [function (e, t, n) {
        function r(e, t) {
          if (e) {
            ...
            for (var i in e) {
              n = e[i], r && (r += " "), r += !n && p[i] ? i : i + '="' + (t.decodeEntities ? c.encodeXML(n) : n) + '"';
            }
      ...
      10: [function (e, t, n) {
        function r(e, t, n) {
          "object" == _typeof(e) ? (n = t, t = e, e = null) : "function" == typeof t && (n = t, t = l), this._callback = e, this._options = t || l, this._elementCB = n, this.dom = [], this._done = !1, this._tagStack = [], this._parser = this._parser || null;
        }
      ...
      14: [function (e, t, n) {
        ...
        n.uniqueSort = function (e) {
          ...
          for (e = e.slice(); --a > -1;) {
            t = e[a], n = e.indexOf(t), n > -1 && n < a && e.splice(a, 1);
          }
      ...
      28: [function (e, t, n) {
        ...
        t.exports = r, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._maxListeners = void 0, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function (e) {
          ...
          } else if (o(n)) for (a = Array.prototype.slice.call(arguments, 1), u = n.slice(), r = u.length, l = 0; l < r; l++) {
            u[l].apply(this, a);
          }
          return !0;
      ...
      31: [function (e, t, n) {
        ...
        e("inherits")(r, e("events").EventEmitter), r.prototype._updatePosition = function (e) {
          ...
          if (this._updatePosition(1), this._lowerCaseTagNames && (e = e.toLowerCase()), !this._stack.length || e in s && !this._options.xmlMode) this._options.xmlMode || "br" !== e && "p" !== e || (this.onopentagname(e), this._closeCurrentTag());else {
            ...
            if (t !== -1) {
              if (this._cbs.onclosetag) for (t = this._stack.length - t; t--;) {
      ...
      36: [function (e, t, n) {
        ...
        t.exports = {
          ...
          parseDOM: function parseDOM(e, t) {
            var n = new a(t);
            return new i(n, t).end(e), n.dom;
          },
          parseFeed: function parseFeed(e, n) {
            var r = new t.exports.FeedHandler(n);
            return new i(r, n).end(e), r.dom;
          },
          createDomStream: function createDomStream(e, t, n) {
            var r = new a(e, t, n);
            return new i(r, t);
          },
          EVENTS: {
      ...
      46: [function (e, t, n) {
        (function (n) {
          ...
          function o(e, t, n, r, i) {
            var a = c(t, n);
            if (a) e.emit("error", a);else if (null === n) t.reading = !1, p(e, t);else if (t.objectMode || n && n.length > 0) {
              if (t.ended && !i) {
          ...
          a.ReadableState = i;
          var I,
              D = (e("events").EventEmitter, function (e, t) {
    ...
    return function n(e, t, r) {
      ...
      2: [function (e, t, n) {
        ...
        s.prototype.add = function (e, t) {
          if (o.isObject(e)) for (var n in e) {
            this.authz[n] = e[n];
      ...
      3: [function (e, t, n) {
        ...
        g.prototype.initialize = function (e, t) {
          ...
          if (this.fetchSpecTimeout && (n.timeout = this.fetchSpecTimeout), this.spec && "object" == _typeof(this.spec)) t.swaggerObject = this.spec, setTimeout(function () {
            ...
            for (var g in h) {
              if (a.extractExtensions(g, h), "scopes" === g) {
                ...
                if ("object" == _typeof(y)) {
                  ...
                  for (var v in y) {
                    a.extractExtensions(v, y), 0 === v.indexOf("x-") && delete y[v];
                  }
                }
              }
            }
          ...
          if (Array.isArray(e.tags)) for (c = {}, n = 0; n < e.tags.length; n++) {
            ...
            for (u in b) {
              if ("externalDocs" === u && "object" == _typeof(b[u])) for (var w in b[u]) {
          ...
          c.prototype.execute = function (t, n) {
            ...
            if (this.binaryRequest(c) && u.on("request", function () {
              ...
              if (0 === p.indexOf("multipart/form-data")) {
                if (delete l["Content-Type"], "[object FormData]" === {}.toString.apply(e.body)) u.send(e.body);else {
                  var h, f, d;

                  for (h in e.body) {
                    if (f = e.body[h], Array.isArray(f)) for (d in f) {
                      u.field(h, d);
                    } else u.field(h, f);
                  }
                }
            ...
            "function" == typeof u.buffer && u.buffer(), u.end(function (t, n) {
              ...
              if (!t && n.error && (t = n.error), t && e.on && e.on.error) {
                ...
                "function" == typeof r && r.isBuffer(c) ? l.data = c : l.obj = "object" == _typeof(c) ? c : null, l.status = n.status, l.statusText = n.text, a = e.on.response;
              }
      ...
      6: [function (e, t, n) {
        ...
        l.prototype.processAllOf = function (e, t, n, r, i, a) {
          ...
          for (d in e.definitions) {
            ...
            if (j.$ref) this.resolveInline(l, e, j, S, A, j);else {
              for (y in j.properties) {
                g = j.properties[y], s.isArray(g.allOf) ? this.processAllOf(l, d, g, S, A, e) : this.resolveTo(l, g, S, "/definitions");
              }
          ...
          for (d in e.paths) {
            ...
            if (m = e.paths[d], "object" == _typeof(m)) {
              for (O in m) {
                if ("$ref" === O) i = "/paths" + d, this.resolveInline(l, e, m, S, A, i);else {
                  k = m[O];
                  var C = m.parameters || [],
                      I = k.parameters || [];
            ...
            if (l === q.root) {
              if ("ref" === q.resolveAs) {
                ...
                if (q.key && q.key.indexOf("#") === -1 && "/" !== q.key.charAt(0)) {
                  for (M = q.root.split("/"), i = "", a = 0; a < M.length - 1; a++) {
                    i += M[a] + "/";
                  }
          ...
          for (s in n) {
            ...
            if (p) if (e.definitions = e.definitions || {}, "ref" === u.resolveAs) {
              if (o !== !0) for (c in p.obj) {
                l = this.retainRoot(c, p.obj[c], u.root), p.obj[c] = l;
              }
          ...
          if ("undefined" != typeof o && null !== o) {
            if (o.indexOf("#") >= 0) {
              ...
              if (u[0] && 0 === o.indexOf("/")) ;else if (!u[0] || 0 !== u[0].indexOf("http:") && 0 !== u[0].indexOf("https:")) {
                if (u[0] && u[0].length > 0) {
                  for (i = e.split("/"), l = "", a = 0; a < i.length - 1; a++) {
                    l += i[a] + "/";
                  }
          ...
          for (var i in t) {
            if (t.hasOwnProperty(i)) {
              ...
              if ("object" == _typeof(a) && this.resolveAllOf(e, a, n + 1), a && "undefined" != typeof a.allOf) {
                var o = a.allOf;
                ...
                if (s.isArray(o)) {
                  ...
                  for (var u = 0; u < o.length; u++) {
                    ...
                    for (var h in c) {
                      ...
                      } else if (l[h] = s.cloneDeep(c[h]), "properties" === h) for (r in l[h]) {
      ...
      7: [function (e, t, n) {
        ...
        var o = t.exports.getStringSignature = function (e, t) {
          ...
          e = r.resolveSchema(e), "function" != typeof a && (a = function a(e) {
            return (e || {})["default"];
          }), n = n || {};
          var o,
              l,
        ...
        t.exports.schemaToHTML = function (e, t, n, o) {
          ...
          "string" != typeof e && (e = t.title || "Inline Model"), t.definition && (t = t.definition), "function" != typeof o && (o = function o(e) {
            return (e || {})["default"];
          });
      ...
      10: [function (e, t, n) {
        ...
        var i = {
          ...
          var f, d;
          if (l) for (h in l) {
            d = new o(h, l[h], this.models, e.modelPropertyMacro), d && (this.models[h] = d);
          } else l = {};
          ...
          for (x in j) {
            if (a.extractExtensions(x, j), "string" == typeof x && x.indexOf("x-") === -1) {
              ...
              if ("object" == _typeof(E) && "object" == _typeof(E.headers)) {
                var O = E.headers;

                for (var k in O) {
                  var T = O[k];
                  if ("object" == _typeof(T)) for (var C in T) {
        ...
        u.prototype.isDefaultArrayItemValue = function (e, t) {
          ...
          } else if (e && "object" == _typeof(e) && ("object" === e.type || i.isUndefined(e.type))) return new o(void 0, e, this.models, this.parent.modelPropertyMacro);
          ...
          for (var n = {}, r = this.path.replace(/#.*/, ""), i = "", a = 0; a < this.parameters.length; a++) {
            ...
            if ("undefined" != typeof e[o.name]) {
              ...
              if ("string" === o.type && "password" === o.format && t && (s = !0), "path" === o["in"]) {
                var l = new RegExp("{" + o.name + "}", "gi"),
                    u = e[o.name];
                Array.isArray(u) ? u = this.encodePathCollection(o.collectionFormat, o.name, u, s) : "undefined" != typeof o["x-escape"] && o["x-escape"] !== !0 || (u = this.encodePathParam(u, s)), r = r.replace(l, u);
            ...
            } else if ("query" === o["in"] && "undefined" == typeof e[o.name] && o.allowEmptyValue === !0) if (i += "" === i && r.indexOf("?") < 0 ? "?" : "&", "undefined" != typeof o.collectionFormat || "array" === o.type) {
              var c,
                  p = o.collectionFormat || "multi";
              i += Array.isArray(c) ? this.encodeQueryCollection(p, o.name, c, s) : this.encodeQueryCollection(p, o.name, [c], s);
            } else i += this.encodeQueryKey(o.name) + "=" + this.encodeQueryParam("", s);
          }

          var h = this.scheme + "://" + this.host;
          return "/" !== this.basePath && (h += this.basePath), h + r + i;
          ...
          if (e["Content-Type"] && e["Content-Type"].indexOf("multipart/form-data") >= 0 && (d = !0), r && !d) {
            ...
            if ("function" == typeof FormData) {
              ...
              for (o in l) {
                if (i = l[o].param, s = t[o], "undefined" != typeof s) if ("[object File]" === {}.toString.apply(s)) y.append(o, s);else if ("file" === s.type && s.value) y.append(o, s.value);else if (Array.isArray(s)) {
          ...
          return h && (S.timeout = h), this.clientAuthorizations.apply(S, this.operation.security), d.mock === !0 ? (d.requestInterceptor && d.requestInterceptor.apply(S), S) : new s().execute(S, d);
              ...
              if (p) {
                ...
                for (var d = 0; d < this.parameters.length; d++) {
                  ...
                  if ("formData" === m["in"]) {
                    f || (f = "");
                    var g;
                    if (g = "function" == typeof FormData && a.body instanceof FormData ? a.body.getAll(m.name) : a.body[m.name]) if ("file" === m.type) g.name && (f += "-F " + m.name + '=@"' + g.name + '" ');else if (Array.isArray(g)) {
                      if ("multi" === m.collectionFormat) for (var y in g) {
          ...
          for (o = "ssv" === e ? "%20" : "tsv" === e ? "%09" : "pipes" === e ? "|" : ",", i = 0; i < n.length; i++) {
          ...
          var i,
              a = "";
          if (e = e || "default", "default" === e || "multi" === e) for (i = 0; i < n.length; i++) {
            i > 0 && (a += "&"), a += this.encodeQueryKey(t) + "=" + c(this.encodeQueryParam(n[i]), r);
          } else {
            var o = "";
            if ("csv" === e) o = ",";else if ("ssv" === e) o = "%20";else if ("tsv" === e) o = "%09";else if ("pipes" === e) o = "|";else if ("brackets" === e) for (i = 0; i < n.length; i++) {
              0 !== i && (a += "&"), a += this.encodeQueryKey(t) + "[]=" + c(this.encodeQueryParam(n[i]), r);
            }
            if ("" !== o) for (i = 0; i < n.length; i++) {
      ...
      14: [function (e, t, n) {
        ...
        function a(e, t) {
          if (e = d(e, t < 0 ? 0 : 0 | m(t)), !i.TYPED_ARRAY_SUPPORT) for (var n = 0; n < t; n++) {
            e[n] = 0;
          }
          return e;
        }
        ...
        i.prototype.slice = function (e, t) {
          ...
          if (this === e && n < t && t < r) for (a = o - 1; a >= 0; a--) {
            e[a + t] = this[a + n];
          } else if (o < 1e3 || !i.TYPED_ARRAY_SUPPORT) for (a = 0; a < o; a++) {
            e[a + t] = this[a + n];
          ...
          if (n !== t && 0 !== this.length) {
            ...
            var r;
            if ("number" == typeof e) for (r = t; r < n; r++) {
              this[r] = e;
            } else {
              var i = $(e.toString()),
                  a = i.length;
        ...
        !function () {
          ...
          function r() {
            ...
            return this instanceof r ? (e = Object.create(null), this.setCookie = function (r, a, o) {
              ...
              var i, a;
              if (n = e[t]) for (a = 0; a < n.length; a += 1) {
                if (i = n[a], i.expiration_date <= Date.now()) 0 === n.length && delete e[i.name];else if (i.matches(r)) return i;
              }
          ...
          t.prototype.parse = function (e, n, r) {
            if (this instanceof t) {
              ...
              for (this.name = s, this.value = l, i = 1; i < a.length; i += 1) {
                switch (o = a[i].match(/([^=]+)(?:=([\s\S]*))?/), s = o[1].trim().toLowerCase(), l = o[2], s) {
                  case "httponly":
                    this.noscript = !0;
                    break;
      ...
      21: [function (e, t, n) {
        ...
        function o(e, t) {
          var n, r, i, a;
          if (t) for (a = Object.keys(t), n = 0, r = a.length; n < r; n += 1) {
            i = a[n], e[i] = t[i];
          }
          return e;
        }
      ...
      22: [function (e, t, n) {
        ...
        function r(e, t) {
          ...
          for (n = {}, r = Object.keys(t), i = 0, a = r.length; i < a; i += 1) {
            o = r[i], s = String(t[o]), "!!" === o.slice(0, 2) && (o = "tag:yaml.org,2002:" + o.slice(2)), l = e.compiledTypeMap[o], l && R.call(l.styleAliases, s) && (s = l.styleAliases[s]), n[o] = s;
          }
        ...
        function x(e, t, n) {
          ...
          for (r = 0, i = c.length; r < i; r += 1) {
            s = "", 0 !== r && (s += ", "), a = c[r], o = n[a], j(e, t, a, !1, !1) && (e.dump.length > 1024 && (s += "? "), s += e.dump + ": ", j(e, t, o, !1, !1) && (s += e.dump, l += s));
          }
        ...
        function A(e, t, n, r) {
          ...
          for (i = 0, a = f.length; i < a; i += 1) {
            c = "", r && 0 === i || (c += s(e, t)), o = f[i], l = n[o], j(e, t + 1, o, !0, !0, !0) && (u = null !== e.tag && "?" !== e.tag || e.dump && e.dump.length > 1024, u && (c += e.dump && P === e.dump.charCodeAt(0) ? "?" : "? "), c += e.dump, u && (c += s(e, t)), j(e, t + 1, l, !0, u) && (c += e.dump && P === e.dump.charCodeAt(0) ? ":" : ": ", c += e.dump, p += c));
          }
        ...
        function S(e, t, n) {
          ...
          for (i = n ? e.explicitTypes : e.implicitTypes, a = 0, o = i.length; a < o; a += 1) {
            if (s = i[a], (s.instanceOf || s.predicate) && (!s.instanceOf || "object" == _typeof(t) && t instanceof s.instanceOf) && (!s.predicate || s.predicate(t))) {
        ...
        function E(e, t) {
          ...
          for (O(e, i, a), n = 0, r = a.length; n < r; n += 1) {
        ...
        function O(e, t, n) {
          var r, i, a;
          if (null !== e && "object" == _typeof(e)) if (i = t.indexOf(e), i !== -1) n.indexOf(i) === -1 && n.push(i);else if (t.push(e), Array.isArray(e)) for (i = 0, a = e.length; i < a; i += 1) {
            O(e[i], t, n);
      ...
      24: [function (e, t, n) {
        ...
        function g(e, t, n, r) {
          ...
          if (t < n) {
            if (s = e.input.slice(t, n), r) for (i = 0, a = s.length; i < a; i += 1) {
              o = s.charCodeAt(i), 9 === o || 32 <= o && o <= 1114111 || d(e, "expected valid JSON character");
        ...
        function y(e, t, n, r) {
          ...
          for (z.isObject(n) || d(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(n), o = 0, s = i.length; o < s; o += 1) {
        ...
        function v(e, t, n, r, i, a) {
          ...
          if (i = String(i), null === t && (t = {}), "tag:yaml.org,2002:merge" === r) {
            if (Array.isArray(a)) for (o = 0, s = a.length; o < s; o += 1) {
              y(e, t, a[o], n);
            } else y(e, t, a, n);
          ...
          for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; 0 !== (c = e.input.charCodeAt(e.position));) {
            ...
            if (92 === c) {
              if (g(e, n, e.position, !0), c = e.input.charCodeAt(++e.position), r(c)) w(e, !1, t);else if (c < 256 && ie[c]) e.result += ae[c], e.position++;else if ((u = l(c)) > 0) {
                for (a = u, o = 0; a > 0; a--) {
                  c = e.input.charCodeAt(++e.position), (u = s(c)) >= 0 ? o = (o << 4) + u : d(e, "expected hexadecimal character");
                }
        ...
        function O(e, t) {
          ...
          for (e.kind = "scalar", e.result = ""; 0 !== s;) {
            if (s = e.input.charCodeAt(++e.position), 43 === s || 45 === s) G === l ? l = 43 === s ? X : K : d(e, "repeat of a chomping mode identifier");else {
              if (!((o = u(s)) >= 0)) break;
        ...
        function k(e, t) {
          ...
          for (null !== e.anchor && (e.anchorMap[e.anchor] = l), i = e.input.charCodeAt(e.position); 0 !== i && 45 === i && (r = e.input.charCodeAt(e.position + 1), a(r));) {
            if (u = !0, e.position++, w(e, !0, -1) && e.lineIndent <= t) l.push(null), i = e.input.charCodeAt(e.position);else if (n = e.line, L(e, t, W, !1, !0), l.push(e.result), w(e, !0, -1), i = e.input.charCodeAt(e.position), (e.line === n || e.lineIndent > t) && 0 !== i) d(e, "bad indentation of a sequence entry");else if (e.lineIndent < t) break;
          }
        ...
        function L(e, t, n, r, i) {
          var a,
              ...
              m = !1,
              g = !1;
          if (null !== e.listener && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = o = s = Q === n || W === n, r && w(e, !0, -1) && (m = !0, e.lineIndent > t ? f = 1 : e.lineIndent === t ? f = 0 : e.lineIndent < t && (f = -1)), 1 === f) for (; C(e) || I(e);) {
            w(e, !0, -1) ? (m = !0, s = a, e.lineIndent > t ? f = 1 : e.lineIndent === t ? f = 0 : e.lineIndent < t && (f = -1)) : s = !1;
          }
      ...
      33: [function (e, t, n) {
        ...
        function i(e) {
          ...
          for (t = 0; t < i; t++) {
            t % 4 === 0 && t && (l.push(o >> 16 & 255), l.push(o >> 8 & 255), l.push(255 & o)), o = o << 6 | a.indexOf(r.charAt(t));
          }
      ...
      157: [function (e, n, r) {
        (function (e) {
          !function (e) {
            ...
            if ("function" == typeof bootstrap) bootstrap("promise", e);else if ("object" == _typeof(r) && "object" == _typeof(n)) n.exports = e();else if ("function" == typeof t && t.amd) t(e);else if ("undefined" != typeof ses) {
              if (!ses.ok()) return;
              ses.makeQ = e;
            } else {
            ...
            function i(e, t) {
              if ($ && t.stack && "object" == _typeof(e) && null !== e && e.stack && e.stack.indexOf(ie) === -1) {
            ...
            function S(t, n) {
              le && ("object" == _typeof(e) && "function" == typeof e.emit && p.nextTick.runAfter(function () {
            ...
            function j(t) {
              if (le) {
                var n = X(oe, t);
                n !== -1 && ("object" == _typeof(e) && "function" == typeof e.emit && p.nextTick.runAfter(function () {
                  var r = X(se, t);
            ...
            var V,
              ...
              }, "object" == _typeof(e) && "[object process]" === e.toString() && e.nextTick) s = !0, o = function o() {
                e.nextTick(t);
            ...
            p.resolve = p, p.nextTick = W, p.longStackSupport = !1, "object" == _typeof(e) && e && e.env && e.env.Q_DEBUG && (p.longStackSupport = !0), p.defer = h, h.prototype.makeNodeResolver = function () {
              var e = this;
              return function (t, n) {
            ...
            p.resetUnhandledRejections = A, p.getUnhandledReasons = function () {
              ...
              "object" == _typeof(e) && e && e.domain && (a = e.domain.bind(a)), o.then(void 0, a);
      ...
      158: [function (e, t, n) {
        ...
        function o(e) {
          for (var t, n, r = {}, i = e.split("&"), a = 0, o = i.length; a < o; ++a) {
            t = i[a], n = t.indexOf("="), n == -1 ? r[decodeURIComponent(t)] = "" : r[decodeURIComponent(t.slice(0, n))] = decodeURIComponent(t.slice(n + 1));
          }
        ...
        function s(e) {
          ...
          for (var s = 0, l = a.length; s < l; ++s) {
            n = a[s], t = n.indexOf(":"), r = n.slice(0, t).toLowerCase(), i = b(n.slice(t + 1)), o[r] = i;
          }
      ...
      160: [function (e, t, n) {
        ...
        n.clearTimeout = function () {
          ...
          if (t && r(this._data)) for (var i in e) {
            this._data[i] = e[i];
    ...
    updateSwaggerUi: function updateSwaggerUi(e) {
    ...
    onLoadFailure: function onLoadFailure(e) {
    ...
    }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = t(require("b")) : e.SwaggerUi = t(e.b);
  }(this, function () {
    return SwaggerUi;
  }), window.SwaggerUi.utils = {
    parseSecurityDefinitions: function parseSecurityDefinitions(e, t) {
    ...
    parseOauth2Scopes: function parseOauth2Scopes(e) {
      var t,
          n = Object.assign({}, e),
          r = [];
    ...
    authorizeBtnClick: function authorizeBtnClick(e) {
      var t;
      e.preventDefault(), t = {
    ...
    renderAuths: function renderAuths(e) {
      var t = $("<div>"),
          n = !1;
    ...
    handleOne: function handleOne(e) {
      var t = e;
    ...
    isPartiallyAuthorized: function isPartiallyAuthorized() {
      return this.where({
        isLogout: !0
      }).length > 0;
    },
    ...
    renderOneAuth: function renderOneAuth(e) {
      var t,
          n,
          r,
          i = e.get("type");
    ...
    authorizeClick: function authorizeClick(e) {
    ...
    handleOauth2Login: function handleOauth2Login(e) {
      function t(e) {
      ...
      if ("oauth2" !== e.get("type") || !h || "implicit" !== h && "accessCode" !== h) {
        ...
        if (e.get("grantTypes")) {
          ...
          for (var d in f) {
            f.hasOwnProperty(d) && "implicit" === d ? (r = f[d], i = r.loginEndpoint.url, u = r.loginEndpoint.url + "?response_type=token", p.tokenName = t(r)) : f.hasOwnProperty(d) && "accessCode" === d && (r = f[d], i = r.tokenRequestEndpoint.url, u = r.tokenRequestEndpoint.url + "?response_type=code", p.tokenName = t(r));
          }
        }
    ...
    clientCredentialsFlow: function clientCredentialsFlow(e, t, n) {
      this.accessTokenRequest(e, t, n, "client_credentials");
    },
    passwordFlow: function passwordFlow(e, t, n) {
      this.accessTokenRequest(e, t, n, "password", {
        username: t.username,
        password: t.password
      });
    },
    accessTokenRequest: function accessTokenRequest(e, t, n, r, i) {
      i = $.extend({}, {
        scope: e.join(" "),
        grant_type: r
      }, i);
    ...
    initialize: function initialize() {},
    showPetStore: function showPetStore() {
      this.trigger("update-swagger-ui", {
        url: "http://petstore.swagger.io/v2/swagger.json"
      });
    },
    showCustomOnKeyup: function showCustomOnKeyup(e) {
      13 === e.keyCode && this.showCustom();
    },
    showCustom: function showCustom(e) {
    ...
    addResource: function addResource(e, t) {
    ...
    setScopes: function setScopes(e, t) {
    ...
    setClientAuthenticationType: function setClientAuthenticationType(e) {
      var t = $(e.target).val(),
          n = this.$el;
    ...
    setClientSecret: function setClientSecret(e) {
    ...
    render: function render() {
      ...
      if (a = jQuery.inArray(this.model.method, this.model.supportedSubmitMethods()) >= 0, a || (this.model.isReadOnly = !0), this.model.description = this.model.description || this.model.notes, this.model.oauth = null, m = this.model.authorizations || this.model.security) if (Array.isArray(m)) for (l = 0, u = m.length; l < u; l++) {
        ...
        if (P = m[o], "oauth2" === o) for (null === this.model.oauth && (this.model.oauth = {}), void 0 === this.model.oauth.scopes && (this.model.oauth.scopes = []), d = 0, c = P.length; d < c; d++) {
      ...
      if ("undefined" != typeof this.model.responses) {
        ...
        for (r in S) {
          q = S[r], C = null, I = this.model.responses[r].schema, I && I.$ref && (C = I.$ref, C.indexOf("#/definitions/") !== -1 && (C = C.replace(/^.*#\/definitions\//, ""))), this.model.responseMessages.push({
            code: r,
      ...
      if ("undefined" == typeof this.model.responseMessages && (this.model.responseMessages = []), L = null, B = this.model.produces, z = this.contains(B, "xml"), N = !z || this.contains(B, "json"), this.model.successResponse) {
        ...
        for (s in R) {
          q = R[s], this.model.successCode = s, "object" == _typeof(q) && "function" == typeof q.createJSONSample ? (this.model.successDescription = q.description, this.model.headers = this.parseResponseHeaders(q.headers), L = {
      ...
      for ($(this.el).html(Handlebars.templates.operation(this.model)), L ? (L.defaultRendering = this.model.defaultRendering, T = new SwaggerUi.Views.SignatureView({
        ...
        isParam: !1
      }, i.consumes = this.model.consumes, i.produces = this.model.produces, j = this.model.parameters, g = 0, p = j.length; g < p; g++) {
        b = j[g], U = b.type || b.dataType || "", "undefined" == typeof U && (C = b.schema, C && C.$ref && (x = C.$ref, U = 0 === x.indexOf("#/definitions/") ? x.substring("#/definitions/".length) : x)), U && "file" === U.toLowerCase() && (i.consumes || (i.consumes = "multipart/form-data")), b.type = U;
      }

      for (k = new SwaggerUi.Views.ResponseContentTypeView({
        model: i,
        router: this.router
      }), $(".response-content-type", $(this.el)).append(k.render().el), E = this.model.parameters, v = 0, h = E.length; v < h; v++) {
        b = E[v], this.addParameter(b, i.consumes);
      }

      for (O = this.model.responseMessages, w = 0, f = O.length; w < f; w++) {
        M = O[w], M.isXML = z, M.isJSON = N, _.isUndefined(M.headers) || (M.headers = this.parseHeadersType(M.headers)), this.addStatusCode(M);
      }
    ...
    parseHeadersType: function parseHeadersType(e) {
      var t = {
        string: {
          "date-time": "dateTime",
          date: "date"
    ...
    parseResponseHeaders: function parseResponseHeaders(e) {
      var t = "; ",
          n = _.clone(e);
    ...
    addParameter: function addParameter(e, t) {
    ...
    addStatusCode: function addStatusCode(e) {
    ...
    submitOperation: function submitOperation(e) {
      var t, n, r, i, a;
      ...
      if (null !== e && e.preventDefault(), n = $(".sandbox", $(this.el)), t = !0, n.find("input.required").each(function () {
        ...
        if (i = this.getInputMap(n), r = this.isFileUpload(n), a = {
          parent: this
        }, this.options.swaggerOptions) for (var o in this.options.swaggerOptions) {
    ...
    getInputMap: function getInputMap(e) {
    ...
    isFileUpload: function isFileUpload(e) {
      var t,
          n,
          r,
          i,
      ...
      for (t = e.find("input"), n = 0, r = t.length; n < r; n++) {
    ...
    hideResponse: function hideResponse(e) {
      e && e.preventDefault(), $(".response", $(this.el)).slideUp(), $(".response_hider", $(this.el)).fadeOut();
    },
    showResponse: function showResponse(e) {
      var t = JSON.stringify(e, null, "\t").replace(/\n/g, "<br>");
      $(".response_body", $(this.el)).html(_.escape(t));
    },
    showErrorStatus: function showErrorStatus(e, t) {
      t.showStatus(e);
    },
    showCompleteStatus: function showCompleteStatus(e, t) {
      t.showStatus(e);
    },
    formatXml: function formatXml(e) {
      ...
      for (p = /(>)(<)(\/*)/g, f = /[ ]*(.*)[ ]+\n/g, t = /(<.+>)(.+\n)/g, e = e.replace(/\r\n/g, "\n").replace(p, "$1\n$2$3").replace(f, "$1\n").replace(t, "$1\n$2"), c = 0, r = "", l = e.split("\n"), i = 0, o = "other", h = {
        ...
        u = {
          ...
          for (r = [], n = e = 0, t = i; 0 <= t ? e < t : e > t; n = 0 <= t ? ++e : --e) {
            r.push("  ");
          }
    ...
    toggleOperationContent: function toggleOperationContent(e) {
    ...
    showSnippet: function showSnippet() {
      var e,
    ...
    getParamByName: function getParamByName(e) {
      var t;
      if (this.model.parameters) for (t = 0; t < this.model.parameters.length; t++) {
    ...
    toggleParameterSnippet: function toggleParameterSnippet() {
      var e = this.$("[name=parameterContentType]").val();
      this.toggleSnippet(e);
    },
    toggleResponseSnippet: function toggleResponseSnippet() {
      var e = this.$("[name=responseContentType]");
      e.length && this.toggleSnippet(e.val());
    },
    toggleSnippet: function toggleSnippet(e) {
    ...
    var l = function l(e) {
      ...
      "string" != typeof e && (e = t.title || "Inline Model"), t.definition && (t = t.definition), "function" != typeof r && (r = function r(e) {
        return (e || {})["default"];
      });
      ...
      e = l(e), "function" != typeof r && (r = function r(e) {
        return (e || {})["default"];
      }), n = n || {};
      var i,
          a,
    ...
    addOperation: function addOperation(e) {
    ...
    callDocs: function callDocs(e, t) {
    ...
    switchToDescription: function switchToDescription(e) {
    ...
    switchToSnippet: function switchToSnippet(e) {
    ...
    snippetToTextArea: function snippetToTextArea(e) {
    ...
    jsonSnippetMouseDown: function jsonSnippetMouseDown(e) {
      this.model.isParam && (e && e.preventDefault(), this.snippetToTextArea(this.model.sampleJSON));
    },
    xmlSnippetMouseDown: function xmlSnippetMouseDown(e) {
